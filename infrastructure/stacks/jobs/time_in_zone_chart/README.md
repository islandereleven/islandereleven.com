...
The production ECR repository is imported into the prod job stack. The old shared `infrastructure/ecr/lambda` stack keeps a compatibility output for the repository URL, but no longer manages that repository.
